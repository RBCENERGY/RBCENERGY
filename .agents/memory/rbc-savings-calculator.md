...
- ledFactor: **T8/HQL 0.32** (~68% savings), **T5 0.55** (~45%, longer amortization — per user).
- Investment netto per Lichtpunkt incl. Montage: T8 85–146 € (2x58 → 146), HQL highbays 220–600 € by wattage.
