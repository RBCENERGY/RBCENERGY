---
name: RBC GmbH verified company facts
description: Authoritative real-world facts about RBC GmbH / Economic Light Design, sourced from economiclightdesign.de. Use these instead of inventing placeholder marketing claims.
---

Source of truth: https://economiclightdesign.de/ (fetch it to re-verify, don't guess).

**Rule:** Only put verifiable facts on this site. Never reintroduce invented marketing (big-brand clients, project counts, ISO 9001, superlatives like "Marktführer", specific unsourced outcome numbers).

Verified facts:
- **Company:** RBC GmbH, trading as "Economic Light Design". Founded / active **since 2009** (~17 yrs as of 2026 — NOT "two decades", NOT "20 years").
- **Managing director:** Christoph Reinke.
- **Address:** Hardtstraße 80, 69124 Heidelberg. Region served: Heidelberg + ~100km, Süddeutschland.
- **Phone:** +49 (0)6221/18520-20 · **Fax:** -29 · **Email:** info@rbc-energy.de · Facebook page exists.
