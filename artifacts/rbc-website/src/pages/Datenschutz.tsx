...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="space-y-4">
      <h2 className="text-2xl font-display font-bold text-[#1a1a1a]">{title}</h2>
...
function Sub({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="space-y-3">
      <h3 className="text-lg font-display font-bold text-[#1a1a1a]">{title}</h3>
      <div className="text-[#1a1a1a]/70 leading-relaxed space-y-4 text-[15px]">{children}</div>
    </div>
  );
}

const linkClass = "text-[#98B94B] hover:underline break-words";
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto space-y-14">
            <Section title="1. Datenschutz auf einen Blick">
              ...
              <Sub title="Datenerfassung auf unserer Website">
                <p className="font-semibold text-[#1a1a1a]/80">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</p>
                <p>
                  Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen
                  Kontaktdaten können Sie dem Impressum dieser Website entnehmen.
                </p>
                <p className="font-semibold text-[#1a1a1a]/80">Wie erfassen wir Ihre Daten?</p>
                <p>
                ...
                <p className="font-semibold text-[#1a1a1a]/80">Wofür nutzen wir Ihre Daten?</p>
                <p>
                  Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu
                  gewährleisten. Andere Daten können zur Analyse Ihres Nutzerverhaltens verwendet werden.
                </p>
                <p className="font-semibold text-[#1a1a1a]/80">Welche Rechte haben Sie bezüglich Ihrer Daten?</p>
                <p>
              ...
              <Sub title="Analyse-Tools und Tools von Drittanbietern">
                <p>
            ...
            <Section title="2. Allgemeine Hinweise und Pflichtinformationen">
              ...
              <Sub title="Hinweis zur verantwortlichen Stelle">
                ...
                <p>
                  Telefon: <a href="tel:+4962211852020" className={linkClass}>+49 (0) 6221 / 18520-20</a><br />
                  E-Mail: <a href="mailto:info@rbc-energy.de" className={linkClass}>info@rbc-energy.de</a>
                </p>
                <p>
              ...
              <Sub title="Beschwerderecht bei der zuständigen Aufsichtsbehörde">
                <p>
                  ...
                  <a href="https://www.bfdi.bund.de/DE/Infothek/Anschriften_Links/anschriften_links-node.html" target="_blank" rel="noopener noreferrer" className={linkClass}>
                    bfdi.bund.de
                  </a>.
                </p>
              </Sub>
              ...
              <Sub title="Auskunft, Sperrung, Löschung">
                <p>
              ...
              <Sub title="Widerspruch gegen Werbe-Mails">
                <p>
            ...
            <Section title="4. Analyse-Tools und Werbung">
              <Sub title="Google Analytics">
                ...
                <p>
                  Die Speicherung von Google-Analytics-Cookies erfolgt auf Grundlage von Art. 6 Abs. 1 lit.
                ...
                <p className="font-semibold text-[#1a1a1a]/80">IP-Anonymisierung</p>
                <p>
                ...
                <p className="font-semibold text-[#1a1a1a]/80">Browser Plugin</p>
                <p>
                  ...
                  <a href="https://tools.google.com/dlpage/gaoptout?hl=de" target="_blank" rel="noopener noreferrer" className={linkClass}>
                    tools.google.com/dlpage/gaoptout
                  </a>.
                </p>
                <p className="font-semibold text-[#1a1a1a]/80">Widerspruch gegen Datenerfassung</p>
                <p>
                ...
                <p>
                  ...
                  <a href="https://support.google.com/analytics/answer/6004245?hl=de" target="_blank" rel="noopener noreferrer" className={linkClass}>
                    support.google.com/analytics
                  </a>.
                </p>
              </Sub>

              <Sub title="Google reCAPTCHA">
                <p>
                ...
                <p>
                  ...
                  <a href="https://www.google.com/intl/de/policies/privacy/" target="_blank" rel="noopener noreferrer" className={linkClass}>
                    google.com/policies/privacy
                  </a>{" "}
                  und{" "}
                  <a href="https://www.google.com/recaptcha/intro/android.html" target="_blank" rel="noopener noreferrer" className={linkClass}>
            ...
            <Section title="5. Plugins und Tools">
              <Sub title="YouTube">
                <p>
                ...
                <p>
                  ...
                  von YouTube unter:{" "}
                  <a href="https://www.google.de/intl/de/policies/privacy" target="_blank" rel="noopener noreferrer" className={linkClass}>
                    google.de/policies/privacy
                  </a>.
                </p>
              </Sub>

              <Sub title="Google Web Fonts">
                <p>
                ...
                <p>
                  ...
                  <a href="https://developers.google.com/fonts/faq" target="_blank" rel="noopener noreferrer" className={linkClass}>
                    developers.google.com/fonts/faq
                  </a>{" "}
                  und in der Datenschutzerklärung von Google:{" "}
                  <a href="https://www.google.com/policies/privacy/" target="_blank" rel="noopener noreferrer" className={linkClass}>
                    google.com/policies/privacy
                  </a>.
                </p>
              </Sub>
              ...
              <Sub title="LinkedIn Insight Tag">
                <p>
                  Diese Webseite nutzt das LinkedIn Insight Tag, einen Analysedienst der LinkedIn
                  Corporation, 1000 W. Maude Avenue, Sunnyvale, CA 94085, USA. Das LinkedIn Insight Tag
                  ermöglicht es, die Effektivität unserer Werbekampagnen auf LinkedIn zu messen und
                  zielgerichtete Werbung auszuspielen. Hierbei werden Daten wie die URL, Referrer-URL,
                  IP-Adresse, Geräte- und Browsereigenschaften, Zeitstempel und Seitenaufrufe erfasst. Diese
                  Daten werden verschlüsselt, innerhalb von sieben Tagen anonymisiert und innerhalb von 90
                  Tagen gelöscht.
                </p>
                <p>
                  Die Verarbeitung erfolgt auf Grundlage Ihrer Einwilligung gemäß Art. 6 Abs. 1 lit. a
                  DSGVO, sofern Sie diese über unser Cookie-Banner erteilt haben. Sie können Ihre
                  Einwilligung jederzeit widerrufen, indem Sie die Cookie-Einstellungen Ihrer Webseite
                  anpassen.
                </p>
                <p>
                  LinkedIn teilt keine personenbezogenen Daten mit uns, sondern stellt uns lediglich
                  anonymisierte Berichte und Retargeting-Informationen zur Verfügung. Weitere Informationen
                  zur Datenverarbeitung durch LinkedIn finden Sie in der Datenschutzerklärung von LinkedIn.
                </p>
                <p>
                  Wenn Sie nicht möchten, dass LinkedIn Daten sammelt, können Sie dies über die Opt-out-Seite
                  von LinkedIn verhindern:{" "}
                  <a href="https://www.linkedin.com/psettings/guest-controls/retargeting-opt-out" target="_blank" rel="noopener noreferrer" className={linkClass}>
