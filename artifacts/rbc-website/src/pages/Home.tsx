      ...
      <section className="pt-20 pb-8 bg-[#F7F8F9]">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-xl mx-auto mb-10">
            <span className="text-[#98B94B] text-base font-bold uppercase tracking-widest block mb-4">Der Prozess</span>
            <h2 className="text-4xl md:text-5xl font-display font-bold text-[#1a1a1a] leading-tight">
      ...
      <section id="calculator" className="py-20 bg-[#F7F8F9] border-t border-black/6 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-14">
            <span className="text-[#98B94B] text-base font-bold uppercase tracking-widest block mb-4">Einsparrechner</span>
            <h2 className="text-4xl md:text-5xl font-display font-bold text-[#1a1a1a] leading-tight">
      ...
      <section className="py-20 bg-white border-t border-black/6">
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            <Link href="/kontakt">
              <button
                className="inline-flex items-center gap-3 bg-[#98B94B] hover:bg-[#8aaa3f] text-[#0D0F12] font-bold uppercase tracking-widest text-xs px-10 py-5 transition-colors"
